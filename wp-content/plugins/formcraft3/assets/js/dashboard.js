if (FC_1.ajaxurl.indexOf('?') > -1) { FC_1.ajaxurl2 = FC_1.ajaxurl+'&'; } else { FC_1.ajaxurl2 = FC_1.ajaxurl+'?'; }
...
jQuery('body').on('change','[name="template-select-slider"]',function(){
	jQuery( "#template-showcase-form" ).load( FC_1.ajaxurl2+'action=formcraft3_get_template&name='+encodeURIComponent(jQuery('[name="template-select-slider"]:checked').val()), function(response) {
